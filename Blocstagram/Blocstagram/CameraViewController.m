...
//                    [self presentViewController:alertVC animated:YES completion:nil];
                    ...
                    [self alertWithTitle:error.localizedDescription message:error.localizedRecoverySuggestion delegate:self.delegate];
                } else {
                    // #7
...
//                [self presentViewController:alertVC animated:YES completion:nil];
                ...
                [self alertWithTitle:NSLocalizedString(@"Camera Permission Denied", @"camera permission denied title")
                             message:NSLocalizedString(@"This app doesn't have permission to use the camera; please update your privacy settings.", @"camera permission denied recovery suggestion")
...
-(void) alertWithTitle:(NSString *)title message:(NSString *)message delegate:(id<CameraViewControllerDelegate>)object{
    ...
    [alertVC addAction:[UIAlertAction actionWithTitle:NSLocalizedString(@"OK", @"OK button")
        ...
        if([object respondsToSelector:@selector(cameraViewController:didCompleteWithImage:)]){
            [object cameraViewController:self didCompleteWithImage:nil];
        }
